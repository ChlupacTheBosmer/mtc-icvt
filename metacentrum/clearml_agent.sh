...
singularity exec -B $HOMEDIR:/mnt \
$SING_IMAGE /bin/bash -c "pip install clearml clearml-agent; python '$HOMEDIR/pycharm/mtc-icvt/metacentrum/modules/mtc-train/train.py' --dataset '0709b8c1' --datasets_dir\
